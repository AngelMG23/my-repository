...
export const projects1 = [
  {
    ...
    description:
      "This portfolio was edited from an open source template (was built with React.JS and next). I will continue to feed back this site as soon as I pogress both in my personal and professional aims.",
